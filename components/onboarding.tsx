      ...
      >
        <View style={styles.contentContainer}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.title} className="font-figtree-bold text-xl">
              {step.title}
            </Text>
            <Text style={styles.description} className="font-figtree-regular">
              {step.description}
            </Text>
          </View>
      ...
      {showSkip && !isLastStep && (
        <View style={styles.skipContainer}>
          <Button variant="ghost" onPress={handleSkip}>
            <Text className="font-figtree-medium">{skipButtonText}</Text>
          </Button>
        </View>
      )}
      ...
      <View style={styles.buttonContainer}>
        {!isFirstStep && (
          <Button variant="outline" onPress={handleBack} style={{ flex: 1 }}>
            <Text className="font-figtree-medium">{backButtonText}</Text>
          </Button>
        )}
